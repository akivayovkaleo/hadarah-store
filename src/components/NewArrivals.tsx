...
// Componente interno: Card de Produto Novo
function NewProductCard({ product, index }: { product: Product; index: number }) {
...
export default function NewArrivals() {
  ...
  const [activeFilter, setActiveFilter] = useState<'all' | 'havaianas' | 'roupas'>('all');
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-24 md:py-32 px-6 bg-[#141414] overflow-hidden"
    >
      {/* ============================================
          HEADER DA SEÇÃO
          ============================================ */}
      <div className="max-w-7xl mx-auto mb-16 md:mb-24">
        <div className="text-center">
          ...
          >
            As últimas adições à nossa coleção. Peças limitadas que chegam 
            para renovar seu guarda-roupa com exclusividade.
          </p>
